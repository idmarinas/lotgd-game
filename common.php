...
$copyright = sprintf('Game Design and Code: Copyright &copy; 2002-2005, Eric Stevens & JT Traub, &copy; 2006-2007, Dragonprime Development Team, <span class="colDkRed"> &copy 2007-? Oliver Brendel remodelling and enhancing</span>, &copy 2015-%s IDMarinas remodelling and enhancing', date('Y'));
// **** NOTICE ****
// This series of scripts (collectively known as Legend of the Green Dragon
