...
if ($onlinecount < getsetting('maxonline', 0) || 0 == getsetting('maxonline', 0))
{
    ...
    $formLogin = $lotgd_tpl->renderThemeTemplate('content/login.twig', [
...
else
{
    ...
    rawoutput($lotgd_tpl->renderThemeTemplate('content/loginfull.twig', ['text' => translate_inline('Server Full!')]));
    output_notl('`c');
}
