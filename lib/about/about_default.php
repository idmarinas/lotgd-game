...
foreach ($order as $key => $val)
{
    switch($val)
    {
        case '3':
            ...
            output('`6This version is a forked version of 1.1.2 Dragonprime Edition and has code of +nb Edition by Oliver Brender %s.', '(<a href="http://nb-core.org"  target="_blank" rel="noopener noreferrer">NB Core</a>)', true);
            ...
            output('<li>%s</li>', '<a href="https://bitbucket.org/idmarinas/lotgd-game/wiki/Home" target="_blank" rel="noopener noreferrer">More information of requirement and dependencies</a>', true);
            output('</ul>For the download of this version please go to %s where the latest development version (daily snapshots) and stable versions are hosted.', '<a href="https://bitbucket.org/idmarinas/lotgd-game" target="_blank" rel="noopener noreferrer">LOTGD - Game</a>', true);
            ...
            output('In this other repository %s you can find all modules that I use in my version of game. This modules are an adaptation of modules create by others to work in my version.`n', '<a href="https://bitbucket.org/idmarinas/lotgd-modules" target="_blank" rel="noopener noreferrer">LOTGD - Modules</a>', true);
            output_notl("`0`n`n");
        break;
    case "2":
        /* NOTICE
    ...
    case "1":
         ...
         */
        output("MightyE tells you, \"`2Legend of the Green Dragon is a remake of and homage to the classic BBS Door game, Legend of the Red Dragon (aka LoRD) by <a href='http://www.rtsoft.com' target='_blank' rel='noopener noreferrer'>Seth Able Robinson</a>.`@\"", true);
        output("`n`n`@\"`2LoRD is now owned by Gameport (<a href='http://www.gameport.com/bbs/lord.html' target='_blank' rel='noopener noreferrer'>http://www.gameport.com/bbs/lord.html</a>), and they retain exclusive rights to the LoRD name and game. ", true);
         ...
         * Specific section above.
         */
        output("`@\"`2LoGD (after version 0.9.7) is released under a <a href='http://creativecommons.org/licenses/by-nc-sa/2.0/' target='_blank' rel='noopener noreferrer'>Creative Commons License</a>, which essentially means that the source code to the game, and all derivatives of the game must remain open and available upon request.", true);
        output("Version 0.9.7 and before are still available under the <a href='http://www.gnu.org/licenses/gpl.html' target='_blank' rel='noopener noreferrer'>GNU General Public License</a> though 0.9.7 will be the last release under that license.", true);
         ...
         * Specific section above.
         */
        output("`@\"`2You may download the latest official version of LoGD at <a href='http://dragonprime.net/' target='_blank' rel='noopener noreferrer'>DragonPrime</a>  and you can play the Classic version at <a href='http://lotgd.net/' target='_blank' rel='noopener noreferrer'>http://lotgd.net</a>.`@\"`n`n",true);
        //output("`@\"`2The most recent *UNSTABLE* pre-release snapshot is available from <a href='http://dragonprime.net/users/Kendaer/' target='_blank' rel='noopener noreferrer'>http://dragonprime.net/users/Kendaer/</a>.", true);
         ...
         * Specific section above.
         */
        output("`@\"`2Additionally, there is an active modder community located at <a href='http://dragonprime.net' target='_blank' rel='noopener noreferrer'>DragonPrime</a> which may help you find additional features which you may wish to add to your game.", true);
