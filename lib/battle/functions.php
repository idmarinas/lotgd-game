...
function battlegainexperiencegraveyard()
{
    ...
    if ($totalExp)
    {
        $lotgdBattleContent['battleend'][] = [
            ...
            [
                'favor'             => $totalExp,
                'overlordOwnerName' => (string) getsetting('deathoverlord', '`$Ramius`0'),
            ],
        ];
...
{
    \LotgdResponse::pageAddContent(\LotgdTheme::render('{theme}/pages/battle.html.twig', $lotgdBattleContent));
}
