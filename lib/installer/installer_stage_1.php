...
if (md5($licenseview) == '484d213db9a69e79321feafb85915ff1')
{
...
else
{
	...
	output("The license may be referenced at %s.", "<a target='_blank' href='http://creativecommons.org/licenses/by-nc-sa/2.0/legalcode'>the Creative Commons site</a>", true);
}
