...
$license = implode('', pullurl("http://creativecommons.org/licenses/by-nc-sa/2.0/legalcode"));
$license = str_replace("\n",'',$license);
...
$license = implode('', file("LICENSE.txt"));
...
if (isset($licensemd5s[md5($license)])){
	...
	$license = htmlentities($license, ENT_COMPAT, getsetting("charset", "UTF-8"));
