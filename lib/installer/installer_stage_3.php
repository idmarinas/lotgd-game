...
else
{
	...
	rawoutput('<select name="DB_DRIVER"><option value="Mysqli">Mysqli</option><option value="Pdo_Mysql" selected>Pdo_Mysql</option></select>');
	...
	rawoutput("<input name='DB_HOST' value=\"".htmlentities($session['dbinfo']['DB_HOST'], ENT_COMPAT, getsetting('charset', 'utf-8'))."\">");
	...
	rawoutput("<input name='DB_USER' value=\"".htmlentities($session['dbinfo']['DB_USER'], ENT_COMPAT, getsetting('charset', 'utf-8'))."\">");
	...
	rawoutput("<input name='DB_PASS' value=\"".htmlentities($session['dbinfo']['DB_PASS'], ENT_COMPAT, getsetting('charset', 'utf-8'))."\">");
	...
	rawoutput("<input name='DB_NAME' value=\"".htmlentities($session['dbinfo']['DB_NAME'], ENT_COMPAT, getsetting('charset', 'utf-8'))."\">");
	...
	rawoutput("<input name='DB_DATACACHEPATH' value=\"".htmlentities($session['dbinfo']['DB_DATACACHEPATH'], ENT_COMPAT, getsetting('charset', 'utf-8'))."\">");
