...
if (0 < DB::num_rows($result))
{
    ...
    rawoutput("<th><a href='mail.php?sortorder=subject&direction=".('subject' == $sortorder ? $newdirection : $sorting_direction)."'>".('subject' == $sortorder ? $arrow : '')." $subject</a></th>");
    rawoutput("<th><a href='mail.php?sortorder=name&direction=".('name' == $sortorder ? $newdirection : $sorting_direction)."'>".('name' == $sortorder ? $arrow : '')." $from</a></th>");
    rawoutput("<th><a href='mail.php?sortorder=date&direction=".('date' == $sortorder ? $newdirection : $sorting_direction)."'>".('date' == $sortorder ? $arrow : '')." $date</a></th>");
    rawoutput('</tr></thead>');
    $from_list = [];
    $rows = [];
    $userlist = [];
