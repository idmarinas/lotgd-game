...
foreach ($post as $key => $val)
{
    if (isset($userinfo[$key]))
    {
        ...
        elseif ('name' == $key && stripslashes($val) != $oldvalues[$key])
        {
            $updates++;
        ...
        elseif ('title' == $key && isset($oldvalues[$key]) && stripslashes($val) != $oldvalues[$key])
        {
            $updates++;
        ...
        elseif ('ctitle' == $key && isset($oldvalues[$key]) && stripslashes($val) != $oldvalues[$key])
        {
            $updates++;
            $tmp = sanitize_colorname(true, stripslashes($val), true);
            $tmp = preg_replace('/[`][cHw]/', '', $tmp);
        ...
        elseif (('playername' == $key) && stripslashes($val) != $oldvalues[$key])
        {
            $updates++;
            $tmp = sanitize_colorname(true, stripslashes($val), true);
            $tmp = preg_replace('/[`][cHw]/', '', $tmp);
