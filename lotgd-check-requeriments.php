<?php
    ...
    function successFail(array $data)
    {
        $passed = $data['isPassed'] ? 'success' : 'fail';
        ...
        {
            echo "Need {$data['need']}<br>";
            echo "Server {$data['current']}";
        }
        echo '</td>';
    }
?>
        ...
        <div id="main">
            <table>
                ...
                <thead>
                    <tr>
                        <tr>
                            <th scope="colgroup" colspan="<?php echo \count($lotgdVersions); ?>">LoTGD Version</th>
                        </tr>
                        <tr>
                ...
                <tbody>
                    <tr>
                        <?php $hasFail = false; ?>
                        <?php foreach ($lotgdVersions as $version) { ?>
                            <td class="<?php echo $results[$version]['isPassed'] ? 'success' : 'fail'; ?>">
                                <?php if ( ! $results[$version]['isPassed']) { ?>
                                    <?php $hasFail = true; ?>
                                <?php } ?>
                                <?php echo $results[$version]['isPassed'] ? 'Success' : 'Fail'; ?>
                            </td>
                        <?php } ?>
                    </tr>
                </tbody>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($extensionsFullList as $ext => $name) { ?>
                            <tr>
                                <th scope="col" class="smaller"><?php echo $name; ?></th>
                                <?php foreach ($lotgdVersions as $version) { ?>
                                    <?php if (isset($results[$version]['details']['extensions']['details'][$ext])) { ?>
                                        <?php $data   = $results[$version]['details']['extensions']['details'][$ext]; ?>
                                        <?php $passed = $data['isPassed'] ? 'success' : 'fail'; ?>
                                        <td class="<?php echo $passed; ?>"><?php echo \ucfirst($passed); ?></td>
                                    <?php }
else
{ ?>
                                        <td>---</td>
