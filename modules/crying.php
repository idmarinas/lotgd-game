...
function crying_runevent($type) {
	...
	if ($op == "") {
		...
		if ($whathappens<=2){
			...
			output("%s beams at you for your kind-heartedness.`n`n", $session['user']['sex']?"He":"She");
		...
		}elseif ($whathappens>=5){
			output("`@No good deed goes unpunished!  You feel like a better person for returning the ring.");
