...
function dragonplace_getmoduleinfo(){
	$info = array(
		...
		"settings"=>array(
			...
			"chance"=>"Chance of dragon moving to a new cave on new day?,range,0,100,5|90",
			"Note: 0 means the dragon will only move once slain.,note",
			"mvres"=>"Can the dragon move on a resurrection new day?,bool|0",
			"dkmin"=>"At what DK does the dragon become rarer? (0 for always rare),int|1",
			"sdrag"=>"Does finding an empty cave count for seeing the dragon?,bool|1",
			"idrag"=>"Does running to the inn count as seeing the dragon?,bool|1",
			'maxsearch'=>"Max dragon searches per day,range,0,10,1|2",
			"Max searches can be 0 for unlimited and is only useful if the previous options are true,note",
			"Dragon Location - Reward,title",
			"gold"=>"How much gold a player can find in an empty cave?,int|100",
			"gems"=>"How many gems a player can find in an empty cave?,int|2",
			"hp"=>"How many hitpoints a player can lose in an empty cave?,int|5",
			"(just set any of these to greater than 0 to take effect),note",
			"Dragon Location - Scrying,title",
			"scrygems"=>"Cost in gems to scry for the dragon?,int|5",
