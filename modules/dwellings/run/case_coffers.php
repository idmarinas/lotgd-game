...
//Added the commentary/log thingy at the bottom of the page.
	...
	switch ($subop){
		...
		rawoutput("<tr class='trhead'><td colspan=2 style='text-align:center;'>$doot_deposit</td></tr>");
		...
		rawoutput("<tr class='trhead'><td colspan=2 style='text-align:center;'>$doot_withdraw</td></tr>");
		if (get_module_setting("maxgold",$type) != 0){
