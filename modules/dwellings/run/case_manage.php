...
//added missing modulehook
	...
	switch ($subop){
		...
		rawoutput("<tr class='trhead'><td colspan=2 style='text-align:center;'>$doot_general</td></tr>");
		...
		rawoutput("<tr class='trhead'><td colspan=2 style='text-align:center;'>$doot_value</td></tr>");
...
//Coffers Display	
		...
		rawoutput("<tr class='trhead'><td colspan=2 style='text-align:center;'>$doot_coffer</td></tr>");
		rawoutput("<tr height=30px class='trlight'><td>");
		output_notl($goldcof);
		rawoutput("</td><td>");
...
//Selling Option
		...
		if ($session['user']['level'] >= $levelsell) {
			...
			rawoutput("<tr class='trhead'><td colspan=2 style='text-align:center;'>$doot_sell</td></tr>");
