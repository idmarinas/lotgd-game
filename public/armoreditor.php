...
use Lotgd\Core\EntityForm\ArmorType;
...
$repository = Doctrine::getRepository(Armor::class);
...
if ('edit' == $op || 'add' == $op)
{
    ...
    $armorEntity      = $armorEntity ?: new Armor();
    ...
    $form = $lotgdFormFactory->create(ArmorType::class, $armorEntity, [
    ...
    if ($form->isSubmitted() && $form->isValid())
    {
        ...
        $message = (0 !== $id) ? 'armor.form.edit' : 'armor.form.new';
        ...
        $form = $lotgdFormFactory->create(ArmorType::class, $entity, [
            'action' => "armoreditor.php?op=edit&id={$id}&level={$armorlevel}",
            'attr'   => [
                'autocomplete' => 'off',
            ],
