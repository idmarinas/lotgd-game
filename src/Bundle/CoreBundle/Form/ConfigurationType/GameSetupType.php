...
namespace Lotgd\Bundle\CoreBundle\Form\ConfigurationType;

use Laminas\Filter;
use Lotgd\Bundle\CoreBundle\Form\Type\CheckboxType;
use Lotgd\Bundle\CoreBundle\Form\Type\TagifyType;
...
class GameSetupType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $settings = \LotgdKernel::get(\Lotgd\Bundle\CoreBundle\Lib\Settings::class);
