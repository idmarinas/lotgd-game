...
namespace Lotgd\Bundle\CoreBundle\Form\Entity\Creatures;

use Lotgd\Bundle\CoreBundle\Entity\CreaturesTranslation;
...
class WeaponTranslationType extends AbstractType
{
