...
final class Version20210317133257 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP INDEX IDX_8D93D64987C61384, ADD UNIQUE INDEX UNIQ_8D93D64987C61384 (referer_id)');
    ...
    private function lotgdDropTables()
    {
        ...
        $this->addSql('ALTER TABLE user DROP INDEX UNIQ_8D93D64987C61384, ADD INDEX IDX_8D93D64987C61384 (referer_id)');
