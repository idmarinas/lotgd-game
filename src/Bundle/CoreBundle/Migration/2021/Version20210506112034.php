...
final class Version20210506112034 extends AbstractMigration
{
    ...
    private function lotgdCreateTables()
    {
        ...
        $this->addSql('CREATE TABLE petition (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED DEFAULT NULL, avatar_id INT UNSIGNED DEFAULT NULL, problem_type_id INT UNSIGNED DEFAULT NULL, close_user_id INT UNSIGNED DEFAULT NULL, avatar_name VARCHAR(120) DEFAULT NULL, user_of_avatar VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, subject VARCHAR(255) NOT NULL, description TEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, status VARCHAR(255) DEFAULT \'unhandled\' NOT NULL COMMENT \'(DC2Type:petition_status_type_enum)\', ip_address VARCHAR(45) NOT NULL, close_date DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_FF598B03A76ED395 (user_id), INDEX IDX_FF598B0386383B10 (avatar_id), INDEX IDX_FF598B03236E4CE0 (problem_type_id), INDEX IDX_FF598B03EFB7A494 (close_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
    ...
    private function lotgdDropTables()
    {
        ...
        $this->addSql('ALTER TABLE commentary ADD author_id INT UNSIGNED DEFAULT NULL, DROP author, CHANGE clan_id clan_id INT UNSIGNED DEFAULT NULL');
        $this->addSql('ALTER TABLE commentary ADD CONSTRAINT FK_1CAC12CAF675F31B FOREIGN KEY (author_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE commentary ADD CONSTRAINT FK_1CAC12CABEAF84C8 FOREIGN KEY (clan_id) REFERENCES clans (clanid)');
        $this->addSql('CREATE INDEX IDX_1CAC12CAF675F31B ON commentary (author_id)');
        $this->addSql('CREATE INDEX IDX_1CAC12CABEAF84C8 ON commentary (clan_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentary DROP FOREIGN KEY FK_1CAC12CABEAF84C8');
        $this->addSql('DROP INDEX IDX_1CAC12CAF675F31B ON commentary');
        $this->addSql('DROP INDEX IDX_1CAC12CABEAF84C8 ON commentary');
        $this->addSql('ALTER TABLE commentary ADD author INT UNSIGNED DEFAULT 0 NOT NULL, DROP author_id, CHANGE clan_id clan_id INT UNSIGNED DEFAULT 0 NOT NULL');
