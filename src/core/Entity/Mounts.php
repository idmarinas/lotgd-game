...
class Mounts
{
     ...
     * @var int
     *
     * @ORM\Column(name="mountcostgems", type="integer", nullable=false)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="mountcostgold", type="integer", nullable=false)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="mountactive", type="integer", nullable=false)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="mountforestfights", type="integer", nullable=false)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="mountfeedcost", type="integer", nullable=false)
     */
     ...
     * @var string
     *
     * @ORM\Column(name="mountlocation", type="string", length=25, nullable=false)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="mountdkcost", type="integer", nullable=false)
     */
