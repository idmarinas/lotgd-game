...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '7.1.0 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 70100; // Identify version of game in numeric format.
