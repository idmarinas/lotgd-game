...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '6.1.1 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 60101; // Identify version of game in numeric format.
