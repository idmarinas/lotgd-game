...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '5.2.4 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 50204; // Identify version of game in numeric format.
