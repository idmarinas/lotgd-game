...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '5.3.4 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 50304; // Identify version of game in numeric format.
