...
class Kernel extends BaseKernel
{
    ...
    public const VERSION         = '4.10.0 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID      = 41000; // Identify version of game in numeric format.
