...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '5.2.2 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 50202; // Identify version of game in numeric format.
