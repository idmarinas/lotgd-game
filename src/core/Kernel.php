...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '5.5.5 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 50505; // Identify version of game in numeric format.
