...
class Kernel extends BaseKernel
{
    ...
    public const VERSION         = '4.12.0 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID      = 41200; // Identify version of game in numeric format.
