...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '5.0.0 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 50000; // Identify version of game in numeric format.
