...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '5.4.2 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 50402; // Identify version of game in numeric format.
