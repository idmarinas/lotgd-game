...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '5.3.2 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 50302; // Identify version of game in numeric format.
