...
class Kernel extends BaseKernel
{
    ...
    public const VERSION         = '4.11.0 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID      = 41100; // Identify version of game in numeric format.
