...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '5.2.5 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 50205; // Identify version of game in numeric format.
