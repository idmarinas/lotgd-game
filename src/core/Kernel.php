...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '6.2.0 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 60200; // Identify version of game in numeric format.
