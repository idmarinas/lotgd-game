...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '6.0.2 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 60002; // Identify version of game in numeric format.
