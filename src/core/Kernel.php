...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '5.4.1 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 50401; // Identify version of game in numeric format.
