...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '6.0.3 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 60003; // Identify version of game in numeric format.
