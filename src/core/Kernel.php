...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '7.0.3 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 70003; // Identify version of game in numeric format.
