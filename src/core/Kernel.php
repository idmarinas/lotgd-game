...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '6.0.4 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 60004; // Identify version of game in numeric format.
