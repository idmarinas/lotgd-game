...
class Kernel extends BaseKernel
{
    ...
    public const VERSION             = '7.1.10 IDMarinas Edition'; // Version of game in public display format.
    public const VERSION_ID          = 70110; // Identify version of game in numeric format.
