...
class DateTime
{
    ...
    public function __construct(Response $response, Navigation $navigation, Request $request)
    {
    ...
    {
        return \gmdate(getsetting('gametime', 'g:i a'), $this->gameTime());
    }

    public function gameTime(): int
    {
        return $this->convertGameTime(\time());
    }
