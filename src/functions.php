...
// The following functions are only temporary for this 7.x version and will be removed in version 8.0.0
...
if (!function_exists('output')) {
	function output (): void
	{
		...
		LotgdResponse::pageAddContent(LotgdFormat::colorize($text));
	}
}

if (!function_exists('rawoutput')) {
	function rawoutput ($data): void
	{
		LotgdResponse::pageAddContent($data);
	}
}
